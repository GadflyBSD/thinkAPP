 ...
 */
angular.module('MetronicApp').controller('appHeaderActionCtrl', function($rootScope, $scope, $stateParams, appLogic) {
	...
	if($stateParams.ac == 'add'){
		...
		appLogic.getAppHeaderInfo($stateParams.ac, function(result){
			$scope.form = result;
	...
	$scope.submit = function(){
		appLogic.actionAppHeader($stateParams.ac, $scope.form);
	}
});